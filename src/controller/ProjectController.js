...
const projects = [
    ...
    },
    {
        ...
        description: 'Página web para divulgação de projetos pessoais, utilizando no frontend React.js e no backend Node.js com Express, o deploy da aplicação é realizado utilizando o Heroku',
