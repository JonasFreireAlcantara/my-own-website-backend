...
const projects = [
  ...
  {
    title: "Blogs For Everyone",
    description:
      "Plataforma de Blog criado do zero utilizando React, Node, Express, Mongoose, Cloudinary, Disqus, etc. Para desenvolvimento de um blog que tem por objetivo divulgações de conhecimentos na área de tecnologia.",
    url: "https://blogdojonas.herokuapp.com/",
    thumbnail_url: `${process.env.BACKEND_API_URL}/public/blog-do-jonas.png`,
  },
];
